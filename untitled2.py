...
Original file is located at
    https://colab.research.google.com/drive/1HTROI1mIH3npJZpR3_6vcHG7IzcINndC
"""
...
def policy_summarization(pdf_file, policy_text):
    if pdf_file is not None:
        ...
        summary_prompt = (
            "Summarize the following policy document and extract the most important "
            "points, key provisions, and implications:\n\n" + content
        )
    else:
        summary_prompt = (
            "Summarize the following policy document and extract the most important "
            ...
            with gr.Row():
                ...
                with gr.Column():
                    tips_output = gr.Textbox(
                        label="Sustainable Living Tips", lines=15
                    )
            generate_tips_btn.click(
                eco_tips_generator, inputs=keywords_input, outputs=tips_output
            )
            ...
            with gr.Row():
                ...
                with gr.Column():
                    summary_output = gr.Textbox(
                        label="Policy Summary & Key Points", lines=20
                    )
            summarize_btn.click(
